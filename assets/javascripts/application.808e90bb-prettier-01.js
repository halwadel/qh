          ...
          Collapse: (function () {
            ...
            return (
              ...
              (t.update = function () {
                ...
                var r = this.el_.previousElementSibling.previousElementSibling
                  .checked;
                if (r)
              ...
              return (
                ...
                (n.prototype.fetch_ = function () {
                  ...
                  return (function n(r) {
                    return (
                      void 0 === r && (r = 0),
                      fetch(i.base_ + "?per_page=100&sort=updated&page=" + r)
                        .then(function (e) {
                          return e.json();
                        })
                        .then(function (e) {
        ...
        return (function e(c) {
          ...
          function n(e, t, n) {
            if ("undefined" != typeof document) {
              "number" ==
                typeof (n = s({ path: "/" }, a.defaults, n)).expires &&
                ...
                if ("focus" !== e.type || this.index_) {
                  if ("focus" === e.type || "keyup" === e.type) {
                    ...
                    for (
                      ;
                      this.stack_.length &&
                      o.offsetHeight >= o.scrollHeight - 16;
          ...
          (D.Index.prototype.query = function (e) {
            ...
            for (s = 0; s < t.clauses.length; s++) {
                ...
                for (var y = 0; y < p.length; y++) {
                  ...
                  for (m = 0; m < c.fields.length; m++) {
                    ...
                    if (
                      (c.presence == D.Query.presence.REQUIRED &&
                        ((u = u.union(b)),
                        void 0 === o[P] && (o[P] = D.Set.complete)),
                      c.presence != D.Query.presence.PROHIBITED)
                    ) {
                      if (
                        (r[P].upsert(w, c.boost, function (e, t) {
                          return e + t;
                        }),
                        !i[x])
                      ) {
                        for (var k = 0; k < E.length; k++) {
                          var S,
                            T = E[k],
                            L = new D.FieldRef(T, P),
                            R = _[T];
                          void 0 === (S = n[L])
                            ? (n[L] = new D.MatchData(v, P, R))
                            : S.add(v, P, R);
                        }
                        i[x] = !0;
                      }
                    } else
                      void 0 === a[P] && (a[P] = D.Set.empty),
                        (a[P] = a[P].union(b));
                  }
                }
              }
              if (c.presence === D.Query.presence.REQUIRED)
                for (m = 0; m < c.fields.length; m++) {
                  o[(P = c.fields[m])] = o[P].intersect(u);
                }
            }
            ...
            for (s = 0; s < this.fields.length; s++) {
              var P;
              o[(P = this.fields[s])] && (O = O.intersect(o[P])),
                a[P] && (C = C.union(a[P]));
            }
            var Q = Object.keys(n),
              A = [],
            ...
            for (s = 0; s < Q.length; s++) {
              var N = (M = D.FieldRef.fromString(Q[s])).docRef;
